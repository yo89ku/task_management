        ...
        return React.createElement("div", {className: "container"}, 
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "col-md-4"}, 
                    React.createElement("h5", null, "ADD TASK:")
                ), 
                React.createElement("div", {className: "col-md-2"}, 
                    React.createElement("button", {type: "button", className: "btn-floating btn-large waves-effect waves-light black", onClick: this.create }, "+")
                )
            ), 
                    
            React.createElement("div", {className: "row"}, 
                React.createElement("div", {className: "col-md-6"}, 
                    React.createElement("h5", {className: "spacing-bottom"}, "Tasks To Be DONE"), 
                    this.renderList(false)
                ), 
                React.createElement("div", {className: "col-md-6"}, 
                    React.createElement("h5", {className: "spacing-bottom"}, "Tasks Completed"), 
